// Code generated by protoc-gen-tart. DO NOT EDIT. haberdasher
...
class HaberdasherJSONClient implements Haberdasher {
  ...
  /// Haberdasher service makes hats for clients.
  HaberdasherJSONClient(this.baseUrl, this.prefix,
...
class HaberdasherProtobufClient implements Haberdasher {
  ...
  /// Haberdasher service makes hats for clients.
  HaberdasherProtobufClient(this.baseUrl, this.prefix,
      {twirp.ClientHooks? hooks, twirp.Interceptor? interceptor}) {
    if (!baseUrl.endsWith('/')) baseUrl += '/';
    if (!prefix.endsWith('/')) prefix += '/';
    if (prefix.startsWith('/')) prefix = prefix.substring(1);
