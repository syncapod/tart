...
type Haberdasher interface {
	...
	MakeSuit(context.Context, *SuitSizeReq) (*Suit, error)
}
...
func NewHaberdasherProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Haberdasher {
	...
	serviceURL += baseServicePath(pathPrefix, "protos", "Haberdasher")
	urls := [2]string{
		serviceURL + "MakeHat",
		serviceURL + "MakeSuit",
	}
...
func (c *haberdasherProtobufClient) MakeSuit(ctx context.Context, in *SuitSizeReq) (*Suit, error) {
	ctx = ctxsetters.WithPackageName(ctx, "protos")
	ctx = ctxsetters.WithServiceName(ctx, "Haberdasher")
	ctx = ctxsetters.WithMethodName(ctx, "MakeSuit")
	caller := c.callMakeSuit
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *SuitSizeReq) (*Suit, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*SuitSizeReq)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*SuitSizeReq) when calling interceptor")
					}
					return c.callMakeSuit(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Suit)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*Suit) when calling interceptor")
				}
				return typedResp, err
			}
			return nil, err
...
func (c *haberdasherProtobufClient) callMakeSuit(ctx context.Context, in *SuitSizeReq) (*Suit, error) {
	out := new(Suit)
...
func (c *haberdasherJSONClient) MakeSuit(ctx context.Context, in *SuitSizeReq) (*Suit, error) {
	ctx = ctxsetters.WithPackageName(ctx, "protos")
	ctx = ctxsetters.WithServiceName(ctx, "Haberdasher")
	ctx = ctxsetters.WithMethodName(ctx, "MakeSuit")
	caller := c.callMakeSuit
...
func (c *haberdasherJSONClient) callMakeSuit(ctx context.Context, in *SuitSizeReq) (*Suit, error) {
	out := new(Suit)
...
const HaberdasherPathPrefix = "/twirp/protos.Haberdasher/"
...
func (s *haberdasherServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "protos.Haberdasher" {
...
func (s *haberdasherServer) serveMakeSuit(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveMakeSuitJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveMakeSuitProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *haberdasherServer) serveMakeSuitJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "MakeSuit")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	handler := s.Haberdasher.MakeSuit
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *SuitSizeReq) (*Suit, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*SuitSizeReq)
					if !ok {
					...
					return s.Haberdasher.MakeSuit(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Suit)
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Suit and nil error while calling MakeSuit. nil responses are not supported"))
		return
	}
...
func (s *haberdasherServer) serveMakeSuitProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "MakeSuit")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *haberdasherServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "protos", "Haberdasher")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
